...
struct MoranError {
    ...
    static constexpr std::string_view error_code_name(const ErrorCode c) {
        switch (c) {
            case ErrorCode::InvalidPopulationSize:  return "InvalidPopulationSize";
            case ErrorCode::InvalidFitness:         return "InvalidFitness";
            case ErrorCode::InvalidGraph:           return "InvalidGraph";
            case ErrorCode::InvalidInitialState:    return "InvalidInitialState";
